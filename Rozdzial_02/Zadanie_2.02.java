...
/* Zadanie 2.02: Jednoczesna deklaracja i inicjacja zmiennych
*  Zadeklaruj i jednoczesnie zainicjalizuj dwie zmienne calkowite. Wyniki wyswietl na ekranie
*/
...
public class Main {
  public static void main (String[] args) {
    ...
    int drugaLiczba = 20;
    System.out.println("pierwszaLiczba: " + pierwszaLiczba);
    System.out.println("drugaLiczba: " + drugaLiczba);
  }
}
